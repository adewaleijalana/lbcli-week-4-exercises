...
changeaddress=2MvLcssW49n9atmksjwg2ZCMsEMsoj3pzUP

message=$(echo -n "btrust builder 2025" | sha256sum | awk '{print $1}')
...
new_raw_tx_hex=$(bitcoin-cli -regtest -named createrawtransaction inputs='''[ { "txid": "'$txn_id'", "vout": '$utxo_vout_1' }, { "txid": "'$txn_id'", "vout": '$utxo_vout_2' } ]''' outputs='''{ "data": "'$message'", "'$changeaddress'": 0.20000000 }''')
